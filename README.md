...
| [EvanMeek](https://github.com/EvanMeek)       | EvanMeek     | [我不会编程的博客](https://evanmeek.github.io)  | [dotfiles](https://github.com/EvanMeek/dotfiles)             | NULL                                                | [doom-emacs](https://github.com/EvanMeek/dotfiles/tree/master/doom.d) [Evan-Emacs](https://github.com/EvanMeek/.emacs.d "EvanEmacs") | dotfiles 中包含 alacritty、fish shell、fcitx、i3wm、polybar、rofi 、dwm等配置 |
...
| [WindyValley](https://github.com/WindyValley) | 风影         | NULL                                            | NULL                                                         | [nvim](https://github.com/WindyValley/nvim)         | NULL                                                         | 东拼西凑白嫖来的Neovim配置，个人使用感觉很好                 |
